...
all: $(BIN_DIR) $(HEADLESS_TARGET) $(VTK_CONVERTER)
	@echo "Built $(MODE) headless, and vtk converter"
...
.PHONY: clean run debug help seq mpi vtk
...
help:
	@echo "Targets:"
	@echo "  make seq          - Build sequential headless + vtk converter"
	@echo "  make mpi          - Build MPI headless + vtk converter"
	@echo "  make vtk          - Build only the VTK converter"
	@echo "  all               - Build headless + vtk converter"
